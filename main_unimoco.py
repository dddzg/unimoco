...
# ------------------------------------------------------------------------
# Modified from MoCo (https://github.com/facebookresearch/moco)
...
from unimoco.loader import TwoCropsTransform, GaussianBlur
from unimoco import UniMoCo
from losses import UnifiedContrastive
...
# options for unimoco
parser.add_argument('--supervised-list', default='', type=str, metavar='PATH',
                    help='path to the supervised image list (None for full supervised).')
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, labels) in enumerate(train_loader):
        ...
        # TODO: report a better metric
        acc1, acc5 = accuracy(output, fake_targets, topk=(1, 5))
